...
| N+6.29B computer_use_adapter | not merged — those files untouched |
| N+6.30A plug-and-play intake | pushed, awaiting Codex audit |
...
| Rust bridge to computer_use_adapter | Post N+6.29B merge |

---

## 6. Next Integration Steps

1. **Post N+6.29B merge:** wire `ghoti_policy_checker` output into
