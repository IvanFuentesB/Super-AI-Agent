...
| `01_projects/runtime_mvp/tests/test_n6_34a_cua_real_repo_trial.py` | New — 45 tests |
...
| `TestLiveActionRefusal` | live capabilities denied; temporary bridge plans removed |
