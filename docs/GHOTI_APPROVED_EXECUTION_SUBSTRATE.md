...
Approved output roots (exactly the two roots enforced by
`03_scripts/agent_os/approved_executor.py`):
...
- Any local agent process except the two fixed approved workers
- Swarm execution
