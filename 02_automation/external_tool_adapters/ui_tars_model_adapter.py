#!/usr/bin/env python3
"""UI-TARS Model adapter stub (N+4.8A) — SAFE STUB ONLY.

Ghoti-local adapter stub for UI-TARS Model (bytedance/UI-TARS).
...
TOOL_KEY = 'ui_tars_model'
TOOL_NAME = 'UI-TARS Model'
TOOL_SLUG = 'bytedance/UI-TARS'
