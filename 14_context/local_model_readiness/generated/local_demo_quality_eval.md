...
- `classify_next_task`: deterministic_template_available
- `codex_prompt_from_context`: deterministic_template_available
- `identify_repo_bundle`: deterministic_template_available
