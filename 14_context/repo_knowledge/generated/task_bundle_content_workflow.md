# Task Bundle: Supervised Content Workflow

## Purpose

Inspect or improve the local-only content demo without posting.
...
- `python 03_scripts/ghoti_repo_knowledge_map.py --bundle content-workflow --json`
...
Improve the supervised content workflow locally. Keep 8 agents / 100 titles / 100 thumbnails / local preview / no posting truthful.
