# Task Bundle: Local Memory / Context Pack Work

## Purpose

Improve compact memory and copy-paste context without live providers.
...
- `python 03_scripts/ghoti_repo_knowledge_map.py --bundle local-memory --json`
...
Build the next local memory improvement with compact outputs, source-linked truth, and no provider/token wiring.
