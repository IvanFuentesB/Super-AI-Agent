...
- `test_n6_35a_*` → 56 pass after audit-gate fail-closed and source-verification hardening
- N+6.34B is already on current main; this target does not modify CUA files.
